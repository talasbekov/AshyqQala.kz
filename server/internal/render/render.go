...
// Params — версионируемый иммутабельный конфиг методики. Движок (иммутабельность, версии) —
// Story 4.1; здесь задел: render() уже принимает params, числа в прозу пойдут плейсхолдерами.
type Params struct{}
